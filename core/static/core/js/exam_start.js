jQuery_3_6_0(document).ready(function () {
  ...
  function update_question(data) {
    ...
    if (data.question_type === "M") {
      jQuery_3_6_0("#js-options-container").removeClass("d-none");
      jQuery_3_6_0("#js-theory-container").addClass("d-none");
      ...
      if (data.answer) {
        jQuery_3_6_0(`input[name="answer"][value="${data.answer}"]`).prop(
          "checked",
          true
        );
    ...
    } else if (data.question_type === "T") {
      jQuery_3_6_0("#js-options-container").addClass("d-none");
      jQuery_3_6_0("#js-theory-container").removeClass("d-none");
      if (data.theory_answer != null) {
        jQuery_3_6_0("#js-theory-textarea").val(
          data.theory_answer.replace(/<br>/g, "\n")
        );
        $clear_btn.prop("disabled", false);
      } else {
        $clear_btn.prop("disabled", true);
  ...
  function update_pagination(data) {
    if (data.prev_q_num) {
      $prev
        .attr("data-href", "?question=" + data.prev_q_num)
        .prop("disabled", false);
    } else {
    ...
    if (data.next_q_num) {
      $next
        .attr("data-href", "?question=" + data.next_q_num)
        .prop("disabled", false);
    } else {
